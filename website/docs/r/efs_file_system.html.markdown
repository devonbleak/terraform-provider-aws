...
* `provisioned_throughput_in_mibps` - (Optional) The MiB/s of throughput to provision
for this file system. Terraform will automatically handle setting the appropriate
ThroughputMode based on this value.  See the [AWS docs][1] for more information.
